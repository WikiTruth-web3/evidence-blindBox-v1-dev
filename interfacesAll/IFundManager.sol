...
interface IFundManager{
    ...
    // ==========  ==========
    // function payOrderAmount(uint256 boxId_, address buyer_, uint256 amount_) external; （不建议使用）
    
    // function payConfidentialityFee(uint256 boxId_, address buyer_, uint256 amount_) external; （不建议使用）
