...
/**
 * @title IFundManagerOtherChain
 * @notice FundManagerOtherChain contract interface, defining all externally exposed functions and events
 * @dev This interface serves as the top-level constraint for the FundManagerOtherChain contract, ensuring consistency between interface and implementation
 */
interface IFundManagerOtherChain {
    // =====================================================================================
