...
// import { core_contracts_testnet } from "../utils/contracts_address";
// const fs = require('fs');
...
//         return;
//     }
//     const contractSecret_officialToken = core_contracts_testnet.find(c => c.name === "OfficialToken_ERC20Secret");
//     const contractSecret_wroseSecret = core_contracts_testnet.find(c => c.name === "WROSESecret");
