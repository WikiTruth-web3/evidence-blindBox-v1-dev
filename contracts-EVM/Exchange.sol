...
import { IExchange } from "@wikitruth-v1/interfaces-EVM/IExchange.sol";
...
contract Exchange is Context, ExchangeBase, IExchange{
    ...
    function sell(
        ...
        _setBoxListedArgs(boxId_, acceptedToken_, price_, Status.Selling, 365 days);
    }
    ...
    function auction(
        ...
        _setBoxListedArgs(boxId_, acceptedToken_, price_, Status.Auctioning, 30 days);
    }
    ...
    function _bid(uint256 boxId_) internal returns(uint256) {
        ...
        truthBox.setBasicData(boxId_, newPrice, Status.Auctioning, block.timestamp + 30 days);
    ...
    /**
     * @notice Refuse refund function, after refusing refund, the box status becomes Sold
     */
    ...
    */
    ...
    // NOTE Debugging function. Production environment does not need
