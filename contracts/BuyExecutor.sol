...
import {IFundManagerCrossChain} from "@interfaces/sapphire/IFundManagerCrossChain.sol";
import {CoreContracts} from "@interfaces/IContracts.sol";

/**
 * @title BuyExecutor
 * @notice Cross-chain execution entry contract. Invoked only by the authorized backend executor.
 * Interacts with FundManagerCrossChain for payment verification and Exchange for status transitions.
 */
contract BuyExecutor is ModifierV2 {
