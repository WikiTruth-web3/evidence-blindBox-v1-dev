...
describe("TruthBox-ConfidentialityFee- 相关测试", async function () {


  it("设置保密费率", async function () {
    const { 
  ...
  it("缴纳保密费-延长保密时间-过期无法缴纳", async function () {
    const { 
      buyer, 
    ...
    console.log("ConfidFee--feeToken_buyer缴费之前余额:",balanceOf_buyer.toString());
    ///
    ...
    console.log("ConfidFee--feeToken_buyer缴费之后余额——1:",balanceOf_buyer1.toString());
    ...
    console.log("ConfidFee--0缴费之后的价格:",price_0);
    console.log("ConfidFee--1缴费之后的价格:",price_1);
    // =================缴费 2================
    // 只缴费一个
    ...
    console.log("ConfidFee--0缴费之后的价格:",price_0_2);

  });

  it("缴纳保密费-加入黑名单-无法缴纳", async function () {
    const { 
      buyer, 
